...
import org.elasticsearch.action.admin.cluster.node.threads.TransportNodesThreadsAction;
...
import org.elasticsearch.rest.action.admin.cluster.threads.RestNodesThreadsAction;
...
public class ActionModule extends AbstractModule {
    ...
    static Map<String, ActionHandler<?, ?>> setupActions(List<ActionPlugin> actionPlugins) {
        ...
        actions.register(NodesThreadsAction.INSTANCE, TransportNodesThreadsAction.class);
    ...
    public void initRestHandlers(Supplier<DiscoveryNodes> nodesInCluster) {
        ...
        registerHandler.accept(new RestNodesThreadsAction(settings, restController));
