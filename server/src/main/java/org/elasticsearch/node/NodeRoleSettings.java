...
public class NodeRoleSettings {
    ...
    public static final Setting<List<DiscoveryNodeRole>> NODE_EXCLUDE_ROLES_SETTING = Setting.listSetting(
        "node.exclude_roles",
        List.of(),
    ...
    public static final Setting<List<DiscoveryNodeRole>> NODE_INCLUDE_ROLES_SETTING = Setting.listSetting(
        "node.include_roles",
        List.of(),
        DiscoveryNode::getRoleFromRoleName,
        Property.NodeScope
