 ...
 */
final class TranslogIndexedSnapshot extends TranslogSnapshotReader {
     ...
     * @param index  the index from sequence number to position for this snapshot
     */
    TranslogIndexedSnapshot(final BaseTranslogReader reader, final long length, final LongLongMap index) {
        super(reader, length);
        this.index = index;
    }
