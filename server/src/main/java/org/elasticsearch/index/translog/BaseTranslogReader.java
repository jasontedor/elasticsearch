...
public abstract class BaseTranslogReader implements Comparable<BaseTranslogReader> {
    ...
    /**
     * Creates a new indexed snapshot using the specified random-access index to access the underlying snapshot by sequence number.
     *
    ...
    public TranslogIndexedSnapshot newIndexedSnapshot(final LongLongMap index) {
        return new TranslogIndexedSnapshot(this, sizeInBytes(), index);
    }
