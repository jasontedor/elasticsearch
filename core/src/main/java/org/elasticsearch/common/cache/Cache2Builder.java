...
public class Cache2Builder<K, V> {
    ...
    public Cache2Builder<K, V> setMaximumWeight(long maximumWeight) {
        if (maximumWeight < 0) {
     ...
     *                          be greater than 0.
     */
    public Cache2Builder<K, V> setExpireAfterAccess(TimeValue expireAfterAccess) {
     ...
     *                         greater than 0.
     */
    public Cache2Builder<K, V> setExpireAfterWrite(TimeValue expireAfterWrite) {
    ...
    public Cache2Builder<K, V> weigher(ToLongBiFunction<K, V> weigher) {
        Objects.requireNonNull(weigher);
        this.weigher = weigher;
        return this;
    }

    public Cache2Builder<K, V> removalListener(RemovalListener<K, V> removalListener) {
